      ...
      <div className="flex items-center gap-2 flex-wrap">
        {canChange ? (
          <button
            ...
            className="btn-press group flex cursor-pointer items-center gap-1.5 border-2 border-black bg-white px-2.5 py-1.5 rounded-md transition-colors hover:bg-gray-50 shadow-sm font-sans"
          >
            <span
              className="h-2 w-2 rounded-full shrink-0"
              style={{ backgroundColor: color }}
            />
            <span className="text-[10px] text-black font-bold">{name}</span>
            <span className="text-[10px] text-gray-500 transition-colors group-hover:text-black">
              &#9998;
            </span>
          </button>
        ) : (
          <span
            className="px-2.5 py-1.5 text-[10px] text-black font-bold border-2 rounded-md bg-white shadow-sm flex items-center gap-1.5 font-sans"
